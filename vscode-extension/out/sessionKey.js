...
exports.getWorkspaceSessionKey = getWorkspaceSessionKey;
 ...
 */
function getWorkspaceSessionKey() {
    const folders = vscode.workspace.workspaceFolders;
    if (!folders || folders.length === 0) {
        return "vscode::no-workspace";
    }
    const rootPath = folders[0].uri.fsPath;
    const hash = (0, crypto_1.createHash)("sha1").update(rootPath).digest("hex").slice(0, 16);
